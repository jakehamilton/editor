...
(lualine.setup {:options {:globalstatus true
                          ...
                          :theme {:normal {:a {:fg colors.surface-dark
                                  ...
                                  :inactive {:a {:fg colors.surface-dark
                                             ...
                                             :z {:fg colors.surface-dark
                                                 :bg colors.text}}}}
                :sections {:lualine_a [(lambda [] "")]
                           :lualine_b [(doto [:branch]
                                         (tset :icon ""))
                                       :diff]
                           :lualine_c []
                           :lualine_x [(doto [:diagnostics]
                ...
                :inactive_winbar {:lualine_a []
                                  ...
                                  :lualine_c []
                                  :lualine_x []
                                  :lualine_y [(doto [:filetype]
                                                (tset :colored true)
                                                (tset :icon_only true))]
                                  :lualine_z [(doto [:filename]
                                                (tset :file_status true)
                                                (tset :shorting_target 25)
                                                (tset :path 1)
                                                (tset :symbols
